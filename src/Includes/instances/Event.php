...
use Maruf89\CommunityDirectory\Includes\{ClassACF, ClassEvents, ClassErrorHandler, TaxonomyLocation};
...
class Event extends Instance {
    ...
    protected static string $acf_prefix = 'event_';
    protected static string $acf_active_key = 'event_active_key';
    protected static string $acf_active = 'event_active';
